...
## 1. 專案目前狀態
開發包 v1.0.0 RATIFIED；三層結構已啟用（20 Feature／24 Sprint）；待外部依賴備妥後啟動 Sprint 1。
...
## 4. 下一步
git init＋GitHub repo → 外部依賴（Supabase 東京/OAuth/LLM key/首批知識來源）→ Sprint 1（E1-F1 技術棧 PoC）DOR。
